...
move_whaticket_files() {
  ...
  sudo mv /root/whaticket/backend/ecosystem.config.js /home/deploywhaticketplus/whaticket/backend
...
EOF
  sudo su - <<EOF
    chown -R deploywhaticketplus:deploywhaticketplus /home/deploywhaticketplus/whaticket/backend
    chmod -R 777 /home/deploywhaticketplus/whaticket/backend
    chown -R deploywhaticketplus:deploywhaticketplus /home/deploywhaticketplus/whaticket/frontend
    chmod -R 777 /home/deploywhaticketplus/whaticket/frontend
EOF
